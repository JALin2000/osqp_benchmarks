...
CMDS=(
  "python learned_osqp/train.py --dtype float32 --precision low --types random_qp,svm,control,lasso --sizes 200,15,80,15 --normalize_features"
  "python learned_osqp/train.py --dtype float32 --precision low --types random_qp,svm,control,lasso --sizes 200,15,80,15 --adaptive_rho false --normalize_features"

  "python learned_osqp/train.py --dtype float32 --precision low --types random_qp,svm,control,lasso --sizes 200,15,80,15 --normalize_features --alpha_mode scalar"
  "python learned_osqp/train.py --dtype float32 --precision low --types random_qp,svm,control,lasso --sizes 200,15,80,15 --adaptive_rho false --normalize_features --alpha_mode scalar"
)
