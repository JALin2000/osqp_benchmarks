...
#SBATCH --mem=32G                       # 384 GB memory per array task
#SBATCH --array=1-12                    
...
CMDS=(
  "python learned_osqp/train.py --device cuda --precision low --types random_qp --sizes 250 --normalize_features --alpha_mode scalar"
  "python learned_osqp/train.py --device cuda --precision low --types random_qp --sizes 250 --adaptive_rho false --normalize_features --alpha_mode scalar"

  "python learned_osqp/train.py --device cuda --precision low --types svm --sizes 20 --normalize_features --alpha_mode scalar"
  "python learned_osqp/train.py --device cuda --precision low --types svm --sizes 20 --adaptive_rho false --normalize_features --alpha_mode scalar"

  "python learned_osqp/train.py --device cuda --precision low --types control --sizes 100 --normalize_features --alpha_mode scalar"
  "python learned_osqp/train.py --device cuda --precision low --types control --sizes 100 --adaptive_rho false --normalize_features --alpha_mode scalar"
  
  "python learned_osqp/train.py --device cuda --precision low --types lasso --sizes 20 --normalize_features --alpha_mode scalar"
  "python learned_osqp/train.py --device cuda --precision low --types lasso --sizes 20 --adaptive_rho false --normalize_features --alpha_mode scalar"
