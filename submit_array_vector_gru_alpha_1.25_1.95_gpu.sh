...
CMDS=(
  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types random_qp --sizes 250 --normalize_features"
  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types random_qp --sizes 250 --adaptive_rho false --normalize_features"

  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types svm --sizes 20 --normalize_features"
  ...
  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types control --sizes 100 --normalize_features"
  ...
  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types lasso --sizes 20 --normalize_features"
  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types lasso --sizes 20 --adaptive_rho false --normalize_features"

  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types portfolio --sizes 20 --normalize_features"
  "python learned_osqp/train.py --device cuda --model_type gru --precision low --types portfolio --sizes 20 --adaptive_rho false --normalize_features"

  "python learned_osqp/train_control_fixed.py --device cuda --model_type gru --precision low --nx 100 --normalize_features"
